...
public class FavoriteAdapterTeams extends RecyclerView.Adapter<FavoriteAdapterTeams.MyViewHolder> {
    ...
    public FavoriteAdapterTeams(List<ModelTeamsRealm> dataList, Callback callback) {
    ...
    @NonNull
    @Override
    public FavoriteAdapterTeams.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.activity_detail_teams, parent, false);
